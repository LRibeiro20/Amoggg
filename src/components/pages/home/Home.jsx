    ...
    <>
              ...
              <div class="carousel-inner">
                ...
                <div class="carousel-item">
                  ...
                  <h4 className="primary mt-2">
                    Em cerimónia alusiva ao 46º aniversário do HCM
                  </h4>
                </div>
                <div class="carousel-item">
                  ...
                  <div class="carousel-caption d-none d-md-block">
                    <h5>
                      AMOG lança Plano Estratégico para os próximos 5 anos
                    </h5>
                    <p>
      ...
      <div className="text-center bg-light">
        ...
        <p className="paragraph pt-5">
          A Associação Moçambicana de Obstetras e Ginecologistas, e uma<br></br>{" "}
          organização sócio profissional de caracter científico sem fins
          lucrativos, que<br></br> tem como finalidade representar e congregar
          profissionais de saúde que se<br></br> dedicam na saúde sexual e
          reprodutiva
        </p>
        <br />
        <br />
        ...
        <div className="row">
          <div className="col-md-12">
            <div className="fancy-title title-border-color title-center">
              <h3 className="text-center information">Mais informações</h3>
            </div>{" "}
            <br />
            <br />
          </div>
                    ...
                    <div className="col-6">
                      <div className="title title-lg">
                        ...
                        <h4 style={{ color: "darkorange" }}>
                          Uma homenagem ao Dr. Momade Ustá
                        </h4>
                      </div>
                  ...
                  <div className="w-100 mb-5 mt-5">
                    <div className="feature-box fbox-plain fbox-sm fbox-dark">
                      ...
                      <div className="fbox-content">
                        <h3>Noticias</h3>
                        <p>
                          Encontre aqui informações úteis que acontecem no mundo
                          da medicina
                        </p>
                      </div>
                    </div>
                    <div className="w-100 mb-5">
                      <div className="feature-box fbox-plain fbox-sm fbox-dark">
                        ...
                        <div className="fbox-content">
                          <h3>Publicações</h3>
                          <p>Encontre aqui publicações importantes da AMOG</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-100 mb-5 mt-5">
                    <div className="feature-box fbox-plain fbox-sm fbox-dark">
                      ...
                      <div className="fbox-content">
                        ...
                        <p>Um espaço reservado para a interação com os profissionais de medicina</p>
                      </div>
                    </div>
